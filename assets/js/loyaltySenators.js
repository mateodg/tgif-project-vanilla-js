var data= 
{
  ...
  "results":[
    ...
    var membersWithLeastLoyalty = [];
    members[0].sort((a,b) =>{
        return b.votes_against_party_pct - a.votes_against_party_pct
    })
    for (let i = 0; i < 10; i++) {
        membersWithLeastLoyalty.push(members[0][i]);
        statistics.tenWithLeastLoyalty = membersWithLeastLoyalty;
    ...
    var tenWithLeastLoyaltyTable = " ";
    statistics.tenWithLeastLoyalty.forEach(members=>{
        tenWithLeastLoyaltyTable += `<tr><td><a href=${members.url}>${members.first_name} ${members.middle_name || ""} ${members.last_name}</a></td>
        <td>${members.votes_against_party_pct}</td>
        <td>${members.total_votes}</td></tr>`
    });
    document.getElementById('tenWithLeastLoyalty').innerHTML = tenWithLeastLoyaltyTable;
