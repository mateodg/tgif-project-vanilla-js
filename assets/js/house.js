...
var representativesTable = " ";
representatives.forEach(members => {
  representativesTable +=`<tr><td><a href=${members.url}> ${members.first_name} ${members.middle_name || " "} ${members.last_name}</a></td>
  <td>${members.party}</td>
  <td>${members.state}</td>
...
document.getElementById('representativesTable').innerHTML=representativesTable;