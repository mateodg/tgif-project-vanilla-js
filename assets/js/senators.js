...
/*Tabla dinamica de la lista entera de Senadores*/ 
var senators = data.results[0].members;
var senatorsTable = " ";
senators.forEach(members => {
    senatorsTable += `<tr><td><a href = ${members.url}>${members.first_name} ${members.last_name}</a></td>
    <td>${members.party}</td>
    <td>${members.state}</td>
...
document.getElementById('senators_table').innerHTML=senatorsTable;
