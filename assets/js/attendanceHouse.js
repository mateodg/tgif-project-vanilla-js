...
var representatives = data.results[0].members;
...
document.getElementById('partyTable').innerHTML = partyTable;
/*Recorremos los datos para obtener el top 10 de mayor y menor asistencia*/
var members = [senators];
...
var membersWithLeastAttendanceTable = " ";
var membersWithMostAttendanceTable = " ";
statistics.tenWithLeastAttendance.forEach(members=>{
    membersWithLeastAttendanceTable += `<tr><td><a href=${members.url}>${members.first_name} ${members.middle_name || ""} ${members.last_name}</a></td>
    <td>${members.missed_votes || 0}</td>
    <td>${members.missed_votes_pct || 0}</td></tr>`
});
document.getElementById('leastEngagedTable').innerHTML = membersWithLeastAttendanceTable;
statistics.tenWithMostAttendance.forEach(members => {
    membersWithMostAttendanceTable += `<tr><td><a href=${members.url}>${members.first_name} ${members.middle_name || ""} ${members.last_name}</a></td>
    <td>${members.missed_votes || 0}</td>
    <td>${members.missed_votes_pct || 0}</td></tr>`
});
document.getElementById('mostEngagedTable').innerHTML = membersWithMostAttendanceTable;